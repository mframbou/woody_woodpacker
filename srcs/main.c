...
int main(int argc, char **argv)
{
	...
	*(uint64_t *)(payload_content + 2+8+8+8) = text_section->sh_offset;

	// print the 4 8 bytes values
	uint64_t *decryption_values = (uint64_t *)(payload_content + 2);
	printf("Decryption values: 0x%lx 0x%lx 0x%lx 0x%lx\n", decryption_values[0], decryption_values[1], decryption_values[2], decryption_values[3]);
